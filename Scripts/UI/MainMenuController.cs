...
public partial class MainMenuController : Control
{
    ...
    public override void _Ready()
    {
        ...
        var backdrop=new TextureRect {Texture=ChromaArt.LoadArt("UI/Frames/menu_background.png"),ExpandMode=TextureRect.ExpandModeEnum.IgnoreSize,StretchMode=TextureRect.StretchModeEnum.KeepAspectCovered,Modulate=new Color(.48f,.54f,.62f)};
